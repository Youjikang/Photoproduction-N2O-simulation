...
class ImprovedOceanDataVisualizer:
    ...
    def create_latitudinal_plot(self, data_subset, variable, depth, year=None):
        ...
        # 设置坐标轴 - 纬度图的X轴和Y轴标签使用Arial字体22号加粗
        ax.set_ylabel('Latitude', fontsize=22, fontname='Arial', weight='bold')
        ax.set_xlabel(color_config['label'], fontsize=22, fontname='Arial', weight='bold')
    ...
    def create_scatter_plot(self, data_subset, variable, depth, year=None):
        ...
        cbar.set_label(color_config['label'], fontsize=28, fontname='Arial', weight='bold')
        ...
        gl.xlabel_style = {'size': 24, 'family': 'Arial', 'weight': 'bold'}
        gl.ylabel_style = {'size': 24, 'family': 'Arial', 'weight': 'bold'}
