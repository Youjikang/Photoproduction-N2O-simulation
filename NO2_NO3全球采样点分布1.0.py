...
class OceanNitrateNitriteVisualizer:
    ...
    def select_plot_method(self):
        ...
        print("- 边框宽度0.5，无图例")
        print("- 包含三条横断面线：太平洋(-150°,红色)、大西洋(-30°,黑色)、印度洋(90°,蓝色)")
    ...
    def select_color_scale_mode(self):
        ...
        print("- 横断面线: 太平洋(-150°,红色)、大西洋(-30°,黑色)、印度洋(90°,蓝色)")
        print("- 无图例显示")
        print("- 只显示数据点位置，不映射数值到颜色")
        print("=" * 50)
    ...
    def create_combined_scatter_plot(self, data_subset, variables, year_range=None):
        ...
        # 印度洋横断面 (90°, -65°S to 21°N) - 蓝色
        ax.plot([90, 90], [-65, 21], color='blue', linewidth=4, transform=ccrs.PlateCarree(), label='Indian')
    ...
    def run(self):
        ...
        print("- 边框宽度: 0.5")
        print("- 海洋背景: 空白（白色），突出plasma配色数据点")
        print("- 横断面线: 太平洋横断面(-150°,红色)、大西洋横断面(-30°,黑色)、印度洋横断面(90°,蓝色)")
        ...
        print(f"横断面线: 太平洋(-150°,红色)、大西洋(-30°,黑色)、印度洋(90°,蓝色)，线宽4")
