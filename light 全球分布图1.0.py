...
class ChunkedOceanLightVisualizer:
    def __init__(self):
        ...
        # 为不同光谱区域定义标签
        self.color_schemes = {
            'UVB': {'label': 'UVB Irradiance (290-315 nm) [mW/m²]'},
            'UVA': {'label': 'UVA Irradiance (315-400 nm) [mW/m²]'},
            'BLUE': {'label': 'Blue Light Irradiance (400-490 nm) [mW/m²]'}
        }
    ...
    def get_color_config(self, variable):
        ...
        if variable in self.color_schemes:
            ...
            return {
                'cmap': self.selected_colormap,
                'label': f'{variable} Irradiance [mW/m²]'
            }
    ...
    def create_global_map_chunked(self, data_subset, variable, depth, year=None):
        ...
        cbar.set_label(color_config['label'], fontsize=28, fontweight='bold', family='Times New Roman')
        ...
        gl.xlabel_style = {'family': 'Times New Roman', 'weight': 'bold', 'size': 20}
        gl.ylabel_style = {'family': 'Times New Roman', 'weight': 'bold', 'size': 20}
    ...
    def create_latitudinal_plot(self, data_subset, variable, depth, year=None):
        ...
        ax.set_ylabel('Latitude', fontsize=24, fontweight='bold', family='Times New Roman')
        ax.set_xlabel(color_config['label'], fontsize=16.8, fontweight='bold', family='Times New Roman')
